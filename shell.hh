...
#define TYPE_APPEND_OP     9   // ">>" operator
#define TYPE_APPEND_ERR_OP 10  // "2>>" operator 

// control structures
#define TYPE_IF            11  // `if` keyword
#define TYPE_THEN          12  // `then` keyword
#define TYPE_ELSE          13  // `else` keyword
#define TYPE_FI            14  // `fi` keyword
